...
function preload(){
    lighting = loadSound("lighting.wav")
    drop = loadImage("diamond.jpg")
    thunder1 = loadImage("1.png");
    thunder2 = loadImage("2.png");
    thunder3 = loadImage("3.png");
    thunder4 = loadImage("4.png");
    boywalk = loadAnimation("walking_1.png","walking_2.png","walking_3.png","walking_4.png","walking_5.png",
...
function setup(){
    ...
    night.velocityX = -3;
    boy = createSprite(650, 520, 20, 20);
